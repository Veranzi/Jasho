...
class ApiService {
  ...
  Future<Map<String, dynamic>> register({
    ...
    return await _makeRequest('POST', '/auth/signup', body: {
      'email': email,
      'password': password,
      'fullName': fullName,
  ...
  Future<Map<String, dynamic>> getTransactionHistory({
    ...
    return await _makeRequest('GET', '/wallet/history?$queryString');
  }
  ...
  Future<Map<String, dynamic>> deposit({
    ...
    return await _makeRequest('POST', '/wallet/topup', body: {
      'amount': amount,
